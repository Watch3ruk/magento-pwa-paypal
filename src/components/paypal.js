...
import { useCheckmo } from '../talons/usePaypal';
import defaultClasses from './paypal.module.css';
        ...
        <div className={classes.root}>
            <p className={classes.title}>
                <FormattedMessage
                    ...
                    defaultMessage={'Account to make a payment:'}
                />
            </p>
            ...
            <p className={classes.mailingAddressTitle}>
                <FormattedMessage
                    ...
                    defaultMessage={'Send Payment to:'}
                />
            </p>
            ...
            <p className={classes.note}>
                <FormattedMessage
                    id={'checkMo.note'}
                    defaultMessage={
                        'Note: Your order will be shipped once the Transfer has been received and processed.'
                    }
                />
            </p>
            <BillingAddress
